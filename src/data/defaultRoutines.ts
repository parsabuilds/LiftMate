      ...
      muscleGroups: [
        ...
        },
        {
          ...
          exercises: [
            ...
            { id: 'pull-fore-3', name: 'Reverse Curls', sets: 3, reps: '12-15', youtubeId: 'pXx38ZWRYjo' },
          ],
        },
      ],
    },
      ...
      muscleGroups: [
        {
          ...
          exercises: [
            ...
            { id: 'legs-leg-7', name: 'Hip Abduction Machine (Opening)', sets: 3, reps: '15-20', youtubeId: 'Gsm0pNzCZqo' },
            { id: 'legs-leg-8', name: 'Hip Adduction Machine (Closing)', sets: 3, reps: '15-20', youtubeId: 'GUiwgM3MTSk' },
            { id: 'legs-leg-9', name: 'Standing Calf Raises (Bodyweight, on Edge)', sets: 3, reps: '15-20', youtubeId: '-M4-G8p8fmc' },
          ],
        },
        {
          name: 'Shoulders',
