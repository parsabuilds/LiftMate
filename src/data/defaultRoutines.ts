      ...
      muscleGroups: [
        {
          ...
          exercises: [
            ...
            { id: 'legs-leg-7', name: 'Hip Abduction Machine (Opening)', sets: 3, reps: '15-20', youtubeId: 'xbb4pU42CG4' },
            { id: 'legs-leg-8', name: 'Hip Adduction Machine (Closing)', sets: 3, reps: '15-20', youtubeId: 'CjAVezAggkI' },
